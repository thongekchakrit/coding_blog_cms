...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    {position === 'LEFT' && (
      <div className="absolute arrow-btn bottom-5 py-3 cursor-pointer bg-gray-700 left-4 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 text-white w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
        </svg>
      </div>
    )}
    {position === 'RIGHT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-gray-700 right-4 rounded-full">
